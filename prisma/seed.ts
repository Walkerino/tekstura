      ...
      data: [
        {
          ...
          slug: 'portfolio-one',
          title: 'Portfolio One',
          description: 'Лендинг и структура контента для запуска продукта с фокусом на конверсию.',
          tag: 'Веб-дизайн',
        ...
        },
        {
          ...
          slug: 'portfolio-two',
          title: 'Portfolio Two',
          description: 'Обновили айдентику: логотип, палитру и визуальную систему для digital и печати.',
          tag: 'Айдентика',
          coverImageUrl: '/assets/classic.png',
          isPublished: true,
          sortOrder: 1,
        },
        {
          ...
          description: 'Разработали дизайн упаковки с акцентом на полку и читаемую иерархию продукта.',
          tag: 'Дизайн упаковки',
          coverImageUrl: '/assets/classic.png',
          isPublished: true,
          sortOrder: 2,
        },
        {
          ...
          description: 'Спроектировали UX/UI интерфейс сервиса: сценарии, навигацию и ключевые экраны.',
          tag: 'UX/UI',
          coverImageUrl: '/assets/classic.png',
          isPublished: true,
          sortOrder: 3,
